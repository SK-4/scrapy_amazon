...
class CourseScraper(scrapy.Spider):
    ...
    def start_requests(self):
        return [scrapy.FormRequest('https://www.discountreactor.com/coupons/goskills.com', 
    ...
    def parse_discountreactor(self, response):
        couponContainer = response.xpath("//div[@data-section='active']//div[@data-is-share='1']")
        ...
        for coupons in couponContainer:
            ...
            availableOffers['Coupon Code'] = coupons.xpath('//div[@class="offer-list-item-button -use"]/text()').get()
            if availableOffers['Coupon Code'] == 'Get the Deal':
                availableOffers['Coupon Code'] = "OFFER ACTIVATED"
            else:
        ...
        yield scrapy.Request('https://goskills.knoji.com/promo-codes/', self.parse_konji, headers = {'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64; rv:107.0) Gecko/20100101 Firefox/107.0'})
    
    def parse_konji(self, response):

        couponTable = response.xpath("//div[@class='module filter-promo']/h2[contains(text(),'GoSkills Promo Codes: Complete Timetable')]/..")
        ...
        yield scrapy.Request('https://www.retailmenot.com/view/goskills.com', self.parse_retailmenot, headers = {"Host": "www.retailmenot.com","User-Agent": "Mozilla/5.0 (X11; Linux x86_64; rv:107.0) Gecko/20100101 Firefox/107.0"})
    ...
    def parse_retailmenot(self, response):
        ...
        for id in offersId:
            if offersData[f"OfferCard:{id}.redemption.0"]["type"] == "CODE":
                print("hey")
                availableOffers = {
                    'Link': '',
                    'Discount Percentage' : '', 
        ...
        yield self.df_coupons.to_csv("goskill.csv",sep=",")
